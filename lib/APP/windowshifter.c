...
/* DESCRIPTION :                                                              */
/** \windowshifter.c
    Source of windowshifter application. Located at APP.
*/
/*============================================================================*/
...
void PORTC_IRQHandler(void) {
  if(interrupts_GetLeftButtonIntFlag()){          // if interrupt in Left Button
    leds_ToggleBlueBoardLED();                  // Code
    interrupts_ClearLeftButtonIntFlag();        // Clean Left Button interrupt flag
  }
  else{                                         
    if(interrupts_GetRightButtonIntFlag()){       // else if interrupt in Right Button 
      leds_ToggleRedBoardLED();                 // Code
      interrupts_ClearRightButtonIntFlag();     // Clean Right Button interrupt flag
    }
    else{
      /* Do nothing */
    }
